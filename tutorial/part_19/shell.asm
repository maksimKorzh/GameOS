...
execute:
    ...
    mov si, new_line                    ; point SI to new_line
    call print_string                   ; print new line before command is executed
...
new_line db 10, 13, 0
no_file dw 0
file_list dw FILES_ADDR                 ; list
          dw FILES_ADDR + OFFSET        ; edit
          dw FILES_ADDR + 2 * OFFSET    ; run
          dw FILES_ADDR + 3 * OFFSET    ; save
          dw FILES_ADDR + 4 * OFFSET    ; load
          dw FILES_ADDR + 5 * OFFSET    ; new
          dw FILES_ADDR + 6 * OFFSET    ; prog_1
          dw FILES_ADDR + 7 * OFFSET    ; prog_2
          dw FILES_ADDR + 8 * OFFSET    ; prog_3
          dw FILES_ADDR + 9 * OFFSET    ; prog_4
          dw FILES_ADDR + 10 * OFFSET   ; prog_5
          dw no_file
