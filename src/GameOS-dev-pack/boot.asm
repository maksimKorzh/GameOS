...
%define BOOTSECTOR_ADDR 0x7c00      ; physical boot sector address
%define FILES_ADDR 0x0000_7e00      ; physical memory address to load FILES at from sector 2
%define THEME_ADDR 0x0000_8200      ; physical memory address to load theme
%define ASCII_OPCODES 0x0000_8400   ; physical memory address to load ASCII and OPCODES table
...
mov bx, ASCII_OPCODES               ; destination address in RAM of where ASCII table is going to be loaded
mov cl, 18                          ; ASCII sector
